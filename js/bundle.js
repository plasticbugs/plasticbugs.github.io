 ...
 * LICENSE file in the root directory of this source tree.
 */
var m=__webpack_require__(4),n=__webpack_require__(7),p=__webpack_require__(5);
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(17),A=__webpack_require__(4),B=__webpack_require__(5),ca=__webpack_require__(18),da=__webpack_require__(19),ea=__webpack_require__(20),ha=__webpack_require__(21),ia=__webpack_require__(22),C=__webpack_require__(7);
...
var _Skills = __webpack_require__(76);
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'header' },
        _react2.default.createElement('img', { className: 'headshot', src: './images/headshot.png' }),
        _react2.default.createElement(
          'p',
          null,
          'Hi! I\'m Scott Moschella, a software engineer based in San\xA0Francisco,\xA0CA.'
        ),
        _react2.default.createElement(
          'p',
          null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { href: './images/smoschella_resume.pdf' },
            _react2.default.createElement('i', { className: 'fa fa-file-pdf-o fa-2', 'aria-hidden': 'true' }),
            '\xA0My\xA0Resume'
          ),
          _react2.default.createElement(
            'a',
            { href: 'https://www.linkedin.com/in/scott-moschella/' },
            _react2.default.createElement('i', { className: 'fa fa-linkedin', 'aria-hidden': 'true' }),
            '\xA0LinkedIn'
          ),
          _react2.default.createElement(
            'a',
            { href: 'https://www.github.com/plasticbugs' },
...
var Portfolio = function (_React$Component) {
  ...
  function Portfolio(props) {
    ...
    _this.state = {
      projects: [{
        ...
        bullets: ['Architected a modular and extensible back-end with Node.js, Express & MongoDB', 'Integrated Amazon S3 storage API to support a large user-base and enable faster downloads', 'Developed server-side caching of dynamically generated content to reduce server load', 'Implemented asynchronous video to MP3 transcoding with worker queue'],
        ...
        bullets: ['Approx. 2000 active users', 'Designed and architected using best practices with Ruby on Rails and jQuery', 'Integrated the Amazon Product Advertising API to utilize product images and insert referral links', 'Enabled custom URLs with Rails Router'],
        ...
        bullets: [function () {
          return _react2.default.createElement(
            ...
            _react2.default.createElement('i', { className: 'fa fa-smile-o fa-2', 'aria-hidden': 'true' })
          );
        }(), function () {
          return _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement('i', { className: 'fa fa-frown-o fa-2', 'aria-hidden': 'true' })
          );
        }()],
  ...
  _createClass(Portfolio, [{
    key: 'renderLink',
    value: function renderLink(link, icon) {
      var classname = 'fa fa-' + icon + ' fa-2';
      var linktext = icon === 'github' ? 'repo' : 'site';
    ...
    key: 'renderBullets',
    value: function renderBullets(project) {
      if (project.bullets) {
        return _react2.default.createElement(
          'ul',
          { className: 'bullets' },
          project.bullets.map(function (bullet, index) {
            return _react2.default.createElement(
              'li',
              { key: index },
              bullet
    ...
    key: 'renderDetails',
    value: function renderDetails(bullets) {
      if (bullets) {
        return _react2.default.createElement(
          'ul',
    ...
    value: function toggleDetails(index) {
      var projectsCopy = this.state.projects.map(function (project) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'section',
        { className: 'portfolio' },
        _react2.default.createElement('script', { src: 'https://gist.github.com/plasticbugs/b6a6be67c4d73041517fd554c1cc5fc1.js' }),
        _react2.default.createElement(
          'div',
...
var _reactAddonsCssTransitionGroup = __webpack_require__(63);
...
var _TransitionGroup = __webpack_require__(66);
...
var _chainFunction = __webpack_require__(67);
...
var _ChildMapping = __webpack_require__(69);
...
var _removeClass = __webpack_require__(73);

var _removeClass2 = _interopRequireDefault(_removeClass);

var _requestAnimationFrame = __webpack_require__(74);

var _requestAnimationFrame2 = _interopRequireDefault(_requestAnimationFrame);

var _properties = __webpack_require__(75);
...
var _hasClass = __webpack_require__(72);
...
var _SomeCode = __webpack_require__(78);

var _SomeCode2 = _interopRequireDefault(_SomeCode);
...
var SomeCode = function (_React$Component) {
  _inherits(SomeCode, _React$Component);

  function SomeCode(props) {
    _classCallCheck(this, SomeCode);

    return _possibleConstructorReturn(this, (SomeCode.__proto__ || Object.getPrototypeOf(SomeCode)).call(this, props));
  }

  _createClass(SomeCode, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var current = _reactDom2.default.findDOMNode(this);
