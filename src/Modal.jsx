...
class Modal extends React.Component {
  ...
  render() {
    ...
    return <div className="modal">
      ...
      <h2 className="code-title">{this.props.title}<span className="gh-link"><a href={this.props.ghLink}><i className="fa fa-github fa-2" aria-hidden="true"></i>&nbsp;View this repo on Github</a></span></h2>
